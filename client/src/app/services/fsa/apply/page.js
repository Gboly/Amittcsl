...
const ApplicationPage = () => {
  ...
  useEffect(() => {
    ...
    if (courseParam && fsCoursesApplication[courseParam]) {
    ...
    return (
      <div className="success-state">
        ...
        <p>
          ...
          <strong>
            {course ? fsCoursesApplication[course].title : "the course"}
          </strong>
          ...
          {course && (
            <>
              ...
              <div className="course-section">
                <h3>{fsCoursesApplication[course].title}</h3>
                {fsCoursesApplication[course].fields.map((field, idx) => (
                  <div className="form-group course-details" key={idx}>
